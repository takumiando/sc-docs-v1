...
NOTE: `sc-image-ramroot-versal-scobc-v1-ve2302i-sdt-full.wic` is a symlink to
the latest build.
...
NOTE: `sc-image-ramroot-versal-scobc-v1-ve2302e-sdt-full.wic` is a symlink to
the latest build.
...
`build/tmp/deploy/images/versal-scobc-v1-ve2302i-sdt-full/`.
...
`build/tmp/deploy/images/versal-scobc-v1-ve2302e-sdt-full/`.
